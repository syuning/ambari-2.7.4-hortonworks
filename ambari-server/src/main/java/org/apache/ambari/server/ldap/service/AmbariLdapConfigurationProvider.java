...
public class AmbariLdapConfigurationProvider extends AmbariServerConfigurationProvider<AmbariLdapConfiguration> {
  ...
  @Inject
  public AmbariLdapConfigurationProvider(AmbariEventPublisher publisher, AmbariJpaPersistService ambariJpaPersistService) {
    super(AmbariServerConfigurationCategory.LDAP_CONFIGURATION, publisher, ambariJpaPersistService);
  }
