...
public class AmbariTProxyConfigurationProvider extends AmbariServerConfigurationProvider<AmbariTProxyConfiguration> {
  ...
  @Inject
  public AmbariTProxyConfigurationProvider(AmbariEventPublisher ambariEventPublisher, AmbariJpaPersistService ambariJpaPersistService) {
    super(AmbariServerConfigurationCategory.TPROXY_CONFIGURATION, ambariEventPublisher, ambariJpaPersistService);
  }
